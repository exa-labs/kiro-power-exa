...
Finding connections that aren't explicitly listed anywhere. Direct queries ("X clients") return articles about the subject, not the actual connections. Use indirect signals instead.
...
```
// Testimonials
web_search_exa { "query": "personal blog [subject] changed my life testimonial", "numResults": 10 }
...
Explicit relationship data is rarely published; implicit signals (shared vocabulary, duration markers, testimonials) are abundant. Search for the signals, not the claim.
